...
const InvitePage = () => {
  ...
  const [accessType, setAccessType] = useState(''); // 'view_only' или 'member'
  ...
  const loadInvitation = async () => {
    try {
      ...
      // Если роль viewer - загружаем проект для просмотра без регистрации
  ...
  const loadProjectForViewing = async (token) => {
    try {
      ...
      setError('Failed to load project for viewing');
    }
  };

  const handleViewAsGuest = () => {
    if (project) {
      // Переходим на страницу проекта в режиме просмотра
  ...
  // Если это viewer приглашение и проект загружен, показываем вариант просмотра без регистрации
        ...
        <div className="max-w-md w-full space-y-8">
          ...
          <div className="space-y-4">
            ...
            >
              ...
              <span>View Project as Guest</span>
            </button>
            
            <div className="text-center">
              <p className="text-sm text-gray-600 mb-2">Or join as member:</p>
              <button
